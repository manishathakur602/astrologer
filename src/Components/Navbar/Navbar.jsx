          ...
          <div className="flex items-center justify-between ">
            ...
            <div className="hidden lg:flex absolute lg:left-1/3 lg:-translate-x-1/3 xl:left-1/2 xl:-translate-x-1/2">
              <ul className="flex gap-8 md:gap-16 text-[#450B00] font-medium">
               ...
               <Link to="/" > <li className="hover:underline cursor-pointer">About</li></Link>
               <Link to="/" > <li className="hover:underline cursor-pointer">Blog</li></Link>
               <Link to="/" > <li className="hover:underline cursor-pointer">Contact</li></Link>
              </ul>
            </div>
