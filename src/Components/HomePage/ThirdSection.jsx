    ...
    <div className="bg-white">
      <div className="md:flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
        ...
        <div className="bg-[#390C05] text-white p-6 flex h-full flex-col justify-center items-center space-y-2">
          <h1 className="text-2xl font-bold text-[#FFC107] lg:text-3xl">Astrology Solution</h1>
          <img src={image3} alt="Decorative" className="w-full h-auto" />
          <p className='text-sm lg:text-lg'>Solve Your All Problem With the Help Of</p>
          <h2 className="text-xl font-semibold md:text-3xl text-[#FFC107]">Shiv Aghori baba ji</h2>
          <p className='text-sm lg:text-xl text-center'>Get Quick Solutions Of your Problems with The Help Of Effective Remedies!</p>
          <img src={image3} alt="Decorative" className="w-full h-auto" />
          <a href="tel:+919876259510" className="flex items-center gap-2 text-[#FFC107] pt-2">
            ...
            <p className="font-medium md:text-xl">+91 9876259510</p>
          </a>
        </div>
